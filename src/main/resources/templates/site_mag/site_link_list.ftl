...
<form name="form1" method="post" action="/Verwalter/sitelink/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/sitelink/edit"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <#if site_link_page??>
        <#list site_link_page.content as item>
            <tr>
                <td align="center">
                ...
                <td align="center"><a href="/Verwalter/sitelink/edit?id=${item.id}">${item.title!""}</a></td>
                <td align="center">${item.linkUri!""}</td>
                <td align="center">${item.isEnable?string("是", "否")}</td>
                <td align="center">
                    <input name="listSortId" type="text" value="${item.sortId!""}" class="sort" onkeydown="return checkNumber(event);">
                </td>
                <td align="center">
                    <a href="/Verwalter/sitelink/edit?id=${item.id}">修改</a>
                </td>
            </tr>
        </#list>
    </#if>
...
<!--内容底部-->
<#assign PAGE_DATA=site_link_page />
