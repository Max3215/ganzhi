...
<form name="form1" method="post" action="/Verwalter/settle/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/settle/edit"><i></i><span>新增</span></a></li>
  ...
  <tr class="odd_bg">
    ...
    <#list settle_list!! as item>
        <tr>
            ...
            <td align="center"><a href="/Verwalter/settle/edit?id=${item.id}">${item.title!""}</a></td>
            <td align="center"><img src="${item.imgUrl!''}" width="90" height="32"/></td>
            ...
            <td align="center">
                <a href="/Verwalter/settle/edit?id=${item.id}">修改</a>
            </td>
        </tr>
    </#list>
