...
<form method="post" action="/Verwalter/settle/save" id="form1">
<div>
...
<div class="location" style="position: static; top: 0px;">
  <a href="/Verwalter/settle/list"><i></i><span>返回列表页</span></a>
...
<div class="content-tab-wrap">
    <div id="floatHead" class="content-tab">
        <div class="content-tab-ul-wrap" >
            <ul>
                <li><a href="javascript:;" onclick="tabs(this);" class="selected">编辑入驻企业</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="tab-content" style="display: block;">
    ...
    <dl>
        <dt>图片</dt>
        <dd>
            <input id="txtImgUrl" name="imgUrl" type="text" value="<#if navi_bar_item??>${navi_bar_item.imgUrl!""}</#if>" class="input normal upload-path">
            ...
            <span class="Validform_checktip">*图片为90px*32px</span>
        </dd>
    </dl>
    <dl>
        <dt>链接网址</dt>
        <dd>
            ...
            <span class="Validform_checktip">*点击跳转的网址</span>
        </dd>
    </dl>
    <dl>
        <dt>是否使能</dt>
    ...
    <dl>
        <dt>备注</dt>
        <dd>
            <input name="mark" type="text" value="<#if navi_bar_item??>${navi_bar_item.mark!""}<#else></#if>" class="input txt100" sucmsg=" ">
            <span class="Validform_checktip">*备注</span>
        </dd>
    </dl>
    <dl>
        <dt>排序数字</dt>
