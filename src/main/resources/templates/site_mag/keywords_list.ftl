...
<form name="form1" method="post" action="/Verwalter/keywords/list" id="form1">
<div>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar" style="position: static; top: 42px;">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="/Verwalter/keywords/edit"><i></i><span>新增</span></a></li>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  ...
  <tr class="odd_bg">
    ...
    <th align="center" width="10%">搜索次数</th>
    <th align="center" width="25%">发布时间</th>
    <th align="center" width="25%">最后搜索</th>
    <th width="8%">排序</th>
    <th width="6%">操作</th>
  </tr>

    <#if keywords_page??>
        <#list keywords_page.content as keywords>
            <tr>
                <td align="center">
...
<!--内容底部-->
<#assign PAGE_DATA=keywords_page />
