...
<form name="form1" method="post" action="/Verwalter/user/consult/list" id="form1">
<div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
  <tbody>
    ...
    <#if user_consult_page??>
        <#list user_consult_page.content as consult>
            <tr>
                <td class="comment">
                  <div class="title">
                    <span class="note">
                  ...
                  <div class="ask">
                    <#if !consult.statusId?? || consult.statusId==0>
...
<!--内容底部-->
<#assign PAGE_DATA=user_consult_page />
